...
public class ConfigurationReader {
   ...
   /*
    In this class, we will creat the reusable logic to read from configuration.properties file
     */

    //1.Creates the properties object -->make it private, so we are limiting access to the object
